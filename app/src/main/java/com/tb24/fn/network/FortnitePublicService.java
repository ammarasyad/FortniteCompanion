...
public interface FortnitePublicService {
	...
	Call<FortMcpResponse> mcp(@Path("command") String command, @Path("id") String accountId, @Query("profileId") String profileId, @Query("rvn") Integer currentProfileRevision, @Body Object payload);
